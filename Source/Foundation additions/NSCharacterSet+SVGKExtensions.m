...
+ (NSCharacterSet *)SVGWhitespaceCharacterSet;
{
    ...
    dispatch_once(&onceToken, ^{
		[SVGKLogger logMessage:@"Allocating static NSCharacterSet containing whitespace characters. Should be small, but Apple seems to take up 5+ megabytes each time?"];
